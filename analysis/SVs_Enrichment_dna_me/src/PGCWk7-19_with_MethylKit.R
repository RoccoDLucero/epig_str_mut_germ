...
library(graphics)
file.list = list(
    "./GSE63818_PGC_7W_embryo1_M_methylation_calling.CpG.bed.sorted",
    "./GSE63818_PGC_10W_embryo1_M_methylation_calling.CpG.bed.sorted",
    "./GSE63818_PGC_11W_embryo1_M_rep1_methylation_calling.CpG.bed.sorted",
    "./GSE63818_PGC_13W_embryo1_M_methylation_calling.CpG.bed.sorted",
    "./GSE63818_PGC_19W_embryo1_M_methylation_calling.CpG.bed.sorted"
    )
sample.list = list("Emb1_M_7w","Emb1_M_10w","Emb1_M_11w","Emb1_M_13w","Emb1_M_19w")
...
#dev.new()
#getCorrelation(methAllSmpCvr,plot = T)
#dev.new()
#PCASamples(meth,screeplot = T)
#dev.new()
#PCASamples(meth,screeplot = F)
#The following 2: 10:15P - 10:24P
...
write.table(x = perc.Meth100kb,
            file = "./GSE63818_PGC_7-19W_embryo1_M_100kb_hg19_methylation.txt",
...
write.table(x = perc.Meth1kb,
            file = "./GSE63818_PGC_7-19W_embryo1_M_1kb_hg19_methylation.txt",
...
write.table(x = xx,
            file = "./GSE63818_PGC_7-19W_embryo1_M_100kb_hg19_meth_plus_del.txt",
            row.names = F,col.names = T,quote = F,sep = "\t")
write.table(x = yy,
            file = "./GSE63818_PGC_7-19W_embryo1_M_1kb_hg19_meth_plus_del.txt",
            row.names = F,col.names = T,quote = F,sep = "\t")
rm(xx,yy)
